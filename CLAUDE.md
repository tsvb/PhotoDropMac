...
The DEBUG-only hash self-check also remains: `XxHash64Vectors.validated` (entry point `xxHash64SelfCheck()`) in [Hasher.swift](Sources/PhotoDropMac/Core/Hasher.swift) asserts XXH64 reference vectors and streaming-split correctness in Debug builds.
